      ...
      }:
      {
        ...
        perSystem =
          ...
          }:
          {
            ...
            apps = {
              zed-editor = {
                program = "${self'.packages.zed-editor}/bin/zeditor";
                meta.description = "Launch zed-editor";
              };
              zed-editor-fhs = {
                program = "${self'.packages.zed-editor-fhs}/bin/zeditor";
                meta.description = "Launch zed-editor-fhs";
              };
              zed-editor-preview = {
                program = "${self'.packages.zed-editor-preview}/bin/zeditor";
                meta.description = "Launch zed-editor-preview";
              };
              zed-editor-preview-fhs = {
                program = "${self'.packages.zed-editor-preview-fhs}/bin/zeditor";
                meta.description = "Launch zed-editor-preview-fhs";
              };
              zed-editor-bin = {
                program = "${self'.packages.zed-editor-bin}/bin/zeditor";
                meta.description = "Launch zed-editor-bin";
              };
              zed-editor-bin-fhs = {
                program = "${self'.packages.zed-editor-bin-fhs}/bin/zeditor";
                meta.description = "Launch zed-editor-bin-fhs";
              };
              zed-editor-preview-bin = {
                program = "${self'.packages.zed-editor-preview-bin}/bin/zeditor";
                meta.description = "Launch zed-editor-preview-bin";
              };
              zed-editor-preview-bin-fhs = {
                program = "${self'.packages.zed-editor-preview-bin-fhs}/bin/zeditor";
                meta.description = "Launch zed-editor-preview-bin-fhs";
              };
            };
          };
